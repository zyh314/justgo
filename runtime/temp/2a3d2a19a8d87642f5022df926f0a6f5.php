<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\WEB\PHP\JustGo0\public/../application/backend\view\edit_role_power.html";i:1526352047;}*/ ?>
<!DOCTYPE html>
<HTML>
<HEAD>
...
<BODY>
  ...
  <SCRIPT type="text/javascript">
    ...
    function storePower() {
      var zTree = $.fn.zTree.getZTreeObj("treeDemo");
      var roleid = Number(localStorage.edit_role_power_roleid);
      var res =  zTree.getChangeCheckedNodes();
      console.log(res);
      var temp = [];
      for(var i = 0;i < res.length;i++){
        if(res[i].checked == true){
          temp.push({pid:res[i].pid,roleid:roleid})
        }
      }
      console.log(temp);
