<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"D:\WEB\PHP\JustGo0\public/../application/backend\view\register.html";i:1526232006;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
layui.use(['form', 'layedit', 'laydate'], function(){
  ...
  form.on('submit(demo1)', function(data){
    ...
    $.ajax({
      url:'<?php echo url("backend/User/addUser"); ?>',
      dataType:'json',
      type:'POST',
      data:data.field,
