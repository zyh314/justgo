<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"C:\AppServ\www\hf171029-stage4\hf1710-justgo\public/../application/index\view\travelmall.html";i:1526221855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-container">
	...
	<div class="layui-row becenter" style="margin: 30px;">
		<div class="layui-inline">
			<input style="width: 600px;" id="keyword" placeholder="输入景点名或目标城市" class="layui-input" >
		</div>
		...
		<div class="layui-col-md4">
			<div class="layui-row">
				<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
					<legend><i style="font-size: 30px;" class="layui-icon layui-icon-tree"></i>选择城市景点</legend>
				</fieldset>
			</div>
			<ul style="display: flex; flex-wrap: wrap;">
				<?php foreach($province as $value): ?>
				<a href="<?php echo url('index/goods/travelgoods'); ?>">
					<li class="locatelist" locateid = "<?php echo $value['locateid']; ?>"><?php echo $value['locate']; ?></li>
				</a>
				<?php endforeach; ?>
			</ul>
		</div>
		...
		<div class="layui-col-md8">
			<div class="layui-row">
				<div class="layui-carousel" id="test10">
					<div carousel-item="">
						<div><img src="http://p4-q.mafengwo.net/s11/M00/1B/90/wKgBEFrQeyKAexG2AAUM4G6g7hQ95.jpeg?imageMogr2%2Fthumbnail%2F%21730x405r%2Fgravity%2FCenter%2Fcrop%2F%21730x405%2Fquality%2F100"></div>
						<div><img src="http://p3-q.mafengwo.net/s11/M00/0B/E4/wKgBEFry0SqAJoVBAAQ2phE_I9E03.jpeg?imageMogr2%2Fthumbnail%2F%21730x405r%2Fgravity%2FCenter%2Fcrop%2F%21730x405%2Fquality%2F100"></div>
					</div>
				</div>
			</div>
			<div class="layui-row" style="margin: 10px;">
				<div class="layui-col-md4">
					<div class="layui-col-md2">
						<i class="layui-icon layui-icon-rmb icon3"></i>
					</div>
				...
				<div class="layui-col-md4">
					<div class="layui-col-md2">
						<i class="layui-icon layui-icon-senior icon3"></i>
					</div>
					<div class="layui-col-md9">
						<strong>海量门票</strong>
						<p>全国票源、自由选择</p>
				...
				<div class="layui-col-md4">
					<div class="layui-col-md2">
						<i class="layui-icon layui-icon-chat icon3"></i>
					</div>
					<div class="layui-col-md9">
						<strong>客服保障</strong>
						<p>专业客服、实时在线</p>
	...
	<!--热销榜-->
	<fieldset class="layui-elem-field" style="margin:45px 0">
		<legend style="color:orangered; font-size: 32px;"><i class="layui-icon layui-icon-fire"></i>热销榜</legend>
		<div class="layui-field-box">
			<span>大家都在买</span>
			<!--热销商品-->
			<ul class="layui-row flexcenter">
				<?php foreach($sellgoods as $value): ?>
				<li class="outbox">
					<a href="traveldetails?goodsid=<?php echo $value['goodsid']; ?>">
						<div class='innerbox'>
							<img style="height:134px;" src='<?php echo $value['image']; ?>' />
						</div>
						<div class='intro'>
		...
		<a href="travelgoods?key=moreSell" style="float: right;">
			<i class="layui-icon layui-icon-next"></i> 查看更多
		</a>
	</fieldset>
	
	<!--新品榜-->
	<fieldset class="layui-elem-field" style="margin:45px 0">
		<legend style="color:orangered; font-size: 32px;"><i class="layui-icon layui-icon-face-surprised"></i>新品榜</legend>
		<div class="layui-field-box">
			<span>新鲜上架</span>
			<!--热门商品-->
			<ul class="layui-row flexcenter">
				<?php foreach($newgoods as $value1): ?>
				<li class="outbox">
					<a href="traveldetails?goodsid=<?php echo $value1['goodsid']; ?>">
						<div class='innerbox'>
							<img style="height:134px;" src='<?php echo $value1['image']; ?>' />
						</div>
						<div class='intro'>
							<!--<p><?php echo $value1['name']; ?></p>-->
							<span><?php echo $value1['intro']; ?></span>
						</div>
						<div class='showprice'>
							<span class="forprice">￥<?php echo $value1['price']; ?></span>
						</div>
					</a>
				</li>
				<?php endforeach; ?>
		...
		<a href="travelgoods?key=moreNew" style="float: right;">
			<i class="layui-icon layui-icon-next"></i> 查看更多
		</a>
	</fieldset>
	...
	<!--人气榜-->
	<fieldset class="layui-elem-field" style="margin:45px 0">
		<legend style="color:orangered; font-size: 32px;"><i class="layui-icon layui-icon-star-fill"></i>人气榜</legend>
		<div class="layui-field-box">
			<span>收藏最多</span>
			<!--热门商品-->
			<ul class="layui-row flexcenter">
				<?php foreach($popular as $value2): ?>
				<li class="outbox">
					<a href="traveldetails?goodsid=<?php echo $value2['goodsid']; ?>">
						<div class='innerbox'>
							<img style="height:134px;" src='<?php echo $value2['image']; ?>' />
						</div>
						<div class='intro'>
							<!--<p><?php echo $value2['name']; ?></p>-->
							<span><?php echo $value2['intro']; ?></span>
						</div>
						<div class='showprice'>
							<span class="forprice">￥<?php echo $value2['price']; ?></span>
						</div>
					</a>
				</li>
				<?php endforeach; ?>
			...
			<a href="travelgoods?key=moreMark" style="float: right;">
...
<script>
	...
	$('#search').click(function(){
		location.href="travelgoods?keyword="+$('#keyword').val();
	})
