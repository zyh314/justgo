<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"C:\AppServ\www\hf171029-stage4\hf1710-justgo\public/../application/backend\view\pending.html";i:1526285118;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-tab layui-tab-card">
  ...
  <div class="layui-tab-content" style="height: 100px;">
    ...
    <div class="layui-tab-item">
    	<table class="layui-table"  lay-size="lg" lay-data="{width: 1092, height:432, url:'../goods/allunpaid', page:true, id:'allunpaid'}" lay-filter="demo">
				<thead>
					<tr>
					  ...
					  <th lay-data="{field:'orderprice', width:80}">单价</th>
    ...
    <div class="layui-tab-item layui-show">
    	...
    	<table class="layui-table" lay-size="lg" lay-data="{width: 1092, height:432, url:'../goods/getpending', page:true, id:'idTest'}" lay-filter="demo">
				<thead>
					<tr>
