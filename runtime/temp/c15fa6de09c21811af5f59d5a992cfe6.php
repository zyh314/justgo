<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"D:\WEB\PHP\justgo\public/../application/index\view\orders_all.html";i:1526278182;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title></title>
...
<script type="text/html" id="barDemo">
  ...
  {{# }else if(d.orderComment == '0' && (d.orderStatus ==3||d.orderStatus ==4)){ }}
  <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="commentOrder">评论</a>
  {{#  }else if(d.orderStatus == '5') { }}
  <a class="layui-btn layui-btn-danger layui-btn-xs layui-disabled" lay-event="orderDel">删除</a>
  {{#  } }}
</script> 
