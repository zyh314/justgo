<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\AppServ\www\hf171029-stage4\hf1710-justgo\public/../application/backend\view\index.html";i:1525607577;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-left">
      ...
      <li class="layui-nav-item"><a href="">景点管理</a></li>
...
<!--       	<ul class="layui-nav layui-nav-tree"  lay-filter="test">
	    ...
	    <ul class="layui-nav layui-nav-tree"  lay-filter="test">
	    	<!-- <a></a> -->
			<!-- 	<li class="layui-nav-item layui-nav-itemed" v-for="item in menuArr">
		      		<a class="" href="javascript:;"></a>
		      		<dl class="layui-nav-child">
						<dd v-for="item1 in menuArr" v-if = 'item1.pfid == item.pid'>
							<a v-bind:id="item1.purl" onclick="chk()"></a>
						</dd>
		      		</dl>
		      	</li> -->
