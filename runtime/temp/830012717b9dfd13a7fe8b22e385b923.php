<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\WEB\PHP\justgo\public/../application/backend\view\edit_admin.html";i:1525919657;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<title></title>
...
<form class="layui-form"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
  <div class="layui-form-item"  style = "display : none">
    ...
    <div class="layui-input-block">
      <input id = 'eid' type="text" name="eid" class="layui-input">
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">用户名称</label>
    <div class="layui-input-block">
      <input id = 'ename' type="text" name="ename" placeholder="请输入" autocomplete="off" class="layui-input" lay-verify="required|username">
    </div>
  </div>
  <div class="layui-form-item">
    ...
    success:function(data){
      ...
      data = data.data;
        ...
        $.ajax({
          ...
          dataType:'json',
          type:'POST',
          data:'eid='+localStorage.editAdminId,
          success:function(data){
            $('#eid').val(data.eid);
            $('#ename').val(data.ename);
            $('#add_admin_role').val(data.rid);
            // form.render('select');
          }
        })
        form.render('select');
